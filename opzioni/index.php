...
?>
						...
						<form class="form col-md-12 center-block" action="index.php" method="post">
							...
							<table style="width:100%;"><tr><td style="width:50%;">Ore
							  <input name="orarioMattinaOre" type="time" class="form-control input-lg" value="<?php echo $orarioMattinaOre; ?>">
							  </td><td>Minuti
							  <input name="orarioMattinaMinuti" type="time" class="form-control input-lg" value="<?php echo $orarioMattinaMinuti; ?>">
							  </td></tr></table><br />
							</div>
							<div class="form-group">Orario Pomeriggio<br />
							<table style="width:100%;"><tr><td style="width:50%;">Ore
							  <input name="orarioPomeriggioOre" type="time" class="form-control input-lg" value="<?php echo $orarioPomeriggioOre; ?>">
							  </td><td>Minuti
							  <input name="orarioPomeriggioMinuti" type="time" class="form-control input-lg" value="<?php echo $orarioPomeriggioMinuti; ?>">
							  </td></tr></table>
							</div>
