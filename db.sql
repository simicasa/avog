create table sede(codice varchar(20), nome varchar(30), unique(codice));
...
create table persona_esame(cf varchar(20), personaID int(7), codiceEsame int(6), dataConsegna date, dataEsame date, seMattina int(1), foreign key(codiceEsame) references esame(codice) on update cascade on delete cascade, foreign key(personaID) references persona(id) on update cascade on delete cascade, primary key (cf, codiceEsame));
/*
